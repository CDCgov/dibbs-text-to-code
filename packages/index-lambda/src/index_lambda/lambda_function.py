...
RESULT_CACHE_INDEX_MAPPING: OpenSearchIndexMapping = {
    ...
    "mappings": {
        "properties": {
            ...
            "loinc_code": {"type": "object", "enabled": False},
            "search_score": {"type": "float"},
            "reranker_score": {"type": "float"},
            "opensearch_retrieved_scores": {"type": "object", "enabled": False},
            "reranker_processed_results": {"type": "object", "enabled": False},
            "cached_at": {"type": "date"},
        },
    },
}
