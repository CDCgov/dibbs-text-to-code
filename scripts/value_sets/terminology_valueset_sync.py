...
def get_loinc_lab_orders():
    ...
    # print(f"URL: {api_url}")
    # print(f"UN: {LOINC_USERNAME}")
    # print(f"PWD: {LOINC_PWD}")
    ...
    if loinc_response.status_code != 200:
        print(f"ERROR Retrieving LOINC ORDER CODES: {loinc_response.status_code}: {loinc_response.text}")
        return
