...
class TestDataTransformer:
    ...
    def test_get_word_count(self):
        ...
        test_result = data_transformer.get_word_count(text)
        ...
        test_result = data_transformer.get_word_count(text_remove_commas)

        assert test_result == expected_count

        test_result = data_transformer.get_word_count(self.LOINC_LAB_TEXT_1)
        expected_count = 4
        assert test_result == expected_count

        test_result = data_transformer.get_word_count(self.LOINC_LAB_TEXT_2)
        expected_count = 9
        assert test_result == expected_count
