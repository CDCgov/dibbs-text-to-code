...
- For more details, read the [data curation README](../packages/data-curation/README.md)
- To generate these SNOINC Extract Files, refer to the [data curation instructions](../packages/data-curation/README.md#instructions)
