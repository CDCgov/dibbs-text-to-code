...
- For more details read [here](../packages/data-curation/README.md)
- To generate these SNOINC Extract Files refer to this [README](../packages/data-curation/README.md#instructions)
